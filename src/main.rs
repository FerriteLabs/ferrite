...
const DOCUMENTATION_URL: &str = "https://github.com/ferritelabs/ferrite-docs";
...
fn cmd_init(
    ...
    println!("  ferrite");
    println!();
    println!("For more information, visit: {DOCUMENTATION_URL}");
...
mod tests {
    ...
    #[test]
    fn generated_config_uses_reachable_documentation_fallback() {
        let config = generate_config_toml(Path::new("./data"), false);
        assert!(config.contains(DOCUMENTATION_URL));
    }
}
